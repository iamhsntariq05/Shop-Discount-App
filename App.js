  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        <View>
          <Text style={styles.headerTexts}> CART </Text>
        </View>
      </View> 
      ...
      <View style={styles.mainView}>
        <TextInput keyboardType={"number-pad"} value={originalPrice} onChangeText={(orgPrice) => setOriginalPrice(orgPrice)} style={styles.textFields} placeholder={"Actual Price"} />
        ...
        <View style={{ flexDirection: 'row' }}>
          <Text style={styles.Fprice}>Discount Price </Text>
         
          <Text style={styles.Fprice}>Saved</Text>

        </View>
        <View style={{ flexDirection: 'row' }}>
          <Text style={styles.finalPriceText}>Rs {finalPrice}</Text>
          <Text style={[styles.finalPriceText, { color: 'red' }]}> Rs {savedAmount}</Text>
        </View>
